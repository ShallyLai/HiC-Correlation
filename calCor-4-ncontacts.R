...
plot_f<-paste("./pngs/corrPlot",output_prefix,".png",sep="_")  
...
for( nor in nors ){
  ...
  table_f<-paste("./tsvs/corDist", output_prefix, nor, ".tsv", sep="_")  
  ...
  for( met in mets){
    cluster_f<-paste("./pngs/cluster", output_prefix, nor, met, ".png", sep="_")
